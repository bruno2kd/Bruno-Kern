...
lord_of_the_rings = media.Movie(
    ...
    "http://www.impawards.com/2003/posters/lord_of_the_rings_the_return_of_the_king_xlg.jpg",
...
titanic = media.Movie(
    "Titanic",
    "A boy and a girl from differing social backgrounds meet during\
                      the ill-fated maiden voyage of the RMS Titanic.",
...
la_la_land = media.Movie(
    "La La Land",
    "Set in modern day Los Angeles, this original musical about\
...
"""
Title, Storyline, Poster image, Trailer on youtube. Could also add imdb ratings in the future.
Choose this movies because were the first that pop up in my mind.
"""

movies = [toy_story, avatar, lord_of_the_rings, fight_club, terminator, matrix,
          titanic, la_la_land, the_force_awakens]
